...
describe('notificationProvider', () => {
            ...
            expect(apiProvider.apiPost).toHaveBeenCalledWith(
                'users/from@example.com/sendMail',
                {
                    message: {
                        ...
                        body: {
                            contentType: 'Text',
                            content: 'A new organisation has been suggested:  Test Organisation Info\nRequested by user: John Doe - john@example.com'
                        },
                        toRecipients: [
                            {
                                emailAddress: {
    ...
    describe('sendInvitationMail', () => {
            ...
            expect(apiProvider.apiPost).toHaveBeenCalledWith(
                'users/from@example.com/sendMail',
                {
                    message: {
                        ...
                        body: {
                            contentType: 'HTML',
                            content: 'You have been added to the following teams: https://teams.microsoft.com/team1, https://teams.microsoft.com/team2'
                        },
                        toRecipients: [
                            {
                                emailAddress: {
        ...
        test('should handle API error in sendInvitationMail', async () => {
            ...
            await expect(notificationProvider.sendInvitationMail(user, mappings)).rejects.toThrow('API Error');
        });
